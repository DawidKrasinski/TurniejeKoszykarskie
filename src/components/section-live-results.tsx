...
export function SectionLiveResults() {
  return (
    <section className="w-full py-12 md:py-20 bg-[#D9A78B]/20">
      <div className="container px-4 md:px-6">
        <div className="grid gap-6 lg:grid-cols-2 lg:gap-12">
          <div className="flex flex-col justify-center space-y-4">
            ...
            <div>
              <RippleButton
                className="bg-[#BF3111] hover:bg-[#BF3111]/90 text-white h-12 px-6 text-base"
          ...
          <div className="flex items-center justify-center">
            <div className="bg-white p-4 rounded-lg shadow-md w-full max-w-md">
              <div className="text-center font-bold mb-4">Turniej Koszykówki 3x3 - Warszawa</div>
              <div className="space-y-2">
