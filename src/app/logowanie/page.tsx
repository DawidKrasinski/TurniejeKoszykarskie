...
export default function LoginPage() {
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    alert("Formularz logowania wysłany!")
  }
        ...
        <div className="container px-4 md:px-6 max-w-md mx-auto">
          <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <p className="text-[#06010D]/70 mb-8">Wróć do platformy i kontynuuj swoją przygodę z koszykówką</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="password" className="text-[#06010D] font-medium">
                      Hasło
                    </Label>
                    <Link href="/reset-hasla" className="text-xs text-[#BF3111] hover:text-[#BF3111]/80">
                      Zapomniałeś hasła?
                    </Link>
                  </div>
                  <Input
                ...
                <div className="pt-4">
                  ...
                  <div className="mt-4 text-center">
                    <Link href="/rejestracja" className="text-[#BF3111] hover:text-[#BF3111]/80 font-medium">
